...
@section('content')
    ...
    <div class="card shadow-lg border-0 rounded-lg mt-3">
        ...
        <div class="card-header card-header-custom">
            ...
            {{-- Search/Filter Form --}}
            <form method="GET" action="{{ route('pending.index') }}" id="searchForm" class="w-100 w-md-auto">
                ...
                @if ($DocRequests->isEmpty())
                    <div class="alert alert-warning text-center my-3">
                        @if (request('search'))
                            ...
                            <a href="{{ route('pending.index') }}" class="btn btn-sm btn-outline-warning ms-2">Clear
                                Search</a>
                        @else
                    ...
                    <div class="modal-content border-0 shadow-sm">
                        ...
                        <div class="modal-body p-0 text-center bg-light">
                            ...
                            @elseif($fileExtension === 'pdf')
                                <div class="p-4">
                                    <iframe src="{{ asset($documentPath) }}" width="100%" height="400px"
