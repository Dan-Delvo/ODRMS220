...
<div class="modal fade" id="requestModal{{ $item->id }}" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content" style="background:#1e293b; color:#f1f5f9; border:1px solid #334155;">

            <!-- Header -->
            <div class="modal-header" style="background:#0f172a; border-bottom:1px solid #334155;">
                <h5 class="modal-title fw-bold" style="color:#1dd3b0; font-size:1.1rem;">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        <p><strong style="color:#1dd3b0;">Document Type:</strong> {{ $item->documents->DocType }}</p>
                        <p><strong style="color:#1dd3b0;">School Entity:</strong> {{ $item->request_schl_entity }}</p>
                        <p><strong style="color:#1dd3b0;">Release Mode:</strong> {{ $item->release_mode }}</p>
                    </div>
                    <div class="col-12 col-md-6 mb-3">
                        @if($item->claimer && $item->claimer->full_name !== 'Blank Blank')
                            <p><strong style="color:#1dd3b0;">Claimer:</strong> {{ $item->claimer->full_name }}</p>
                        @endif
                        <p><strong style="color:#1dd3b0;">Status:</strong> {{ $item->status }}</p>
                        @if($item->remarks)
                            <p><strong style="color:#1dd3b0;">Remarks:</strong> {{ $item->remarks }}</p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer" style="background:#0f172a; border-top:1px solid #334155;">
                <button type="button" class="btn w-100 w-md-auto"
                        style="background:#1dd3b0; color:#0f172a; font-weight:600;"
