    ...
    <div class="col-md-12">
        <div class="card shadow border-0 rounded-lg">
            <div class="card-header text-white d-flex align-items-center justify-content-between" style="background-color: #1f2937; height: 70px;">
                ...
                <a href="{{ route('tables.index') }}" class="btn text-black fw-semibold" style="background-color: #1dd3b0; box-shadow: 0 4px 10px rgba(29, 211, 176, 0.5);">
                    Back
                </a>
            </div>
                ...
                <form action="{{ route('tables.update', $table->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-6">
                            <label>Claimer</label>
                            <input type="text" name="claimer_id" class="form-control" value="{{$table->claimer->full_name}}" />
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" name="status" class="form-control" value="{{$table->status}}" readonly />
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn text-white fw-semibold" style="background-color: #1dd3b0; box-shadow: 0 4px 10px rgba(29, 211, 176, 0.5);">Save Changes</button>
                    </div>
