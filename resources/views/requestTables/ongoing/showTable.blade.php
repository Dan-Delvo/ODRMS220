            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="detail-item">
                        <label>Status</label>
                        <p>
                            <span class="badge" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: #1f2937; font-size: 0.85rem; padding: 0.35rem 0.75rem; border-radius: 8px;">
                                {{ $table->status }}
                            </span>
                        </p>
                    </div>
