...
<style>
    ...
    @media (max-width: 767px) {
        .page-header-create { padding: 1.25rem; border-radius: 12px; }
        .page-header-create h1 { font-size: 1.35rem; }
        .create-card { border-radius: 12px; }
        .create-card-header { padding: 0.875rem 1rem; }
        .create-card-body { padding: 1rem; }
    }
    @media (max-width: 575px) {
        .page-header-create h1 { font-size: 1.15rem; }
        .create-card-header h5 { font-size: 0.875rem; }
