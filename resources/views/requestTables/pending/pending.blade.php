...
<div class="col-md-6">
    <h1 class="mt-4">Pending Requests Total: {{ $totalCount }}</h1>
</div>
</div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('pending.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                    @endif


                                    <a href="{{ route('pending.show', $item->id) }}" class="btn btn-info">Info</a>
                                </td>
                            </tr>
